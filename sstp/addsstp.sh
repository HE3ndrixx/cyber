...
until [[ $user =~ ^[a-zA-Z0-9_]+$ && ${CLIENT_EXISTS} == '0' ]]; do
		...
		CLIENT_EXISTS=$(grep -w $user /var/lib/HE3ndrixx/data-user-sstp | wc -l)
...
$user * $pass *
EOF
echo -e "### $user $exp">>"/var/lib/HE3ndrixx/data-user-sstp"
clear
cat <<EOF

============================
SSTP VPN 🧑‍💻🥷🎮☁️🎰🌊🛫☁️☁️☁️☁️☁️☁️☁️🏦💵♾️⛽ Cyberpunk☁️
============================
IP/Host   : $IP
Domain    : $domain
Username  : $user
...
Expired   : $exp
============================
Script By 🧑‍💻🥷🎮☁️🎰🌊🛫☁️☁️☁️☁️☁️☁️☁️🏦💵♾️⛽ Cyberpunk☁️
EOF