...
until [[ $VPN_USER =~ ^[a-zA-Z0-9_]+$ && ${CLIENT_EXISTS} == '0' ]]; do
		...
		CLIENT_EXISTS=$(grep -w $VPN_USER /var/lib/HE3ndrixx/data-user-pptp | wc -l)
...
echo -e "### $VPN_USER $exp">>"/var/lib/HE3ndrixx/data-user-pptp"
cat <<EOF

============================
🧑‍💻🥷🎮☁️🎰🌊🛫☁️☁️☁️☁️☁️☁️☁️🏦💵♾️⛽ Cyberpunk☁️PPTP VPN
============================
IP/Host   : $PUBLIC_IP
Domain    : $domain
Username  : $VPN_USER
...
Expired   : $exp
============================
Script By TOpPLUG☁️☁️☁️☁️☁️🧑‍💻Cyberpunk🌊🧑‍💻☁️☁️☁️☁️☁️☁️🎰🗽☁️
EOF